   ...
   private:
    ...
    void step_1b(string_typeT& text) {
        ...
        if (regress_trim) {
            if (stem<string_typeT>::is_suffix(
                ...
                stem<string_typeT>::is_suffix(
                    text,
                    /*bl*/ common_lang_constants::LOWER_B,
                    common_lang_constants::UPPER_B,
                    common_lang_constants::LOWER_L,
                    common_lang_constants::UPPER_L) ||
                stem<string_typeT>::is_suffix(
                    text,
                    /*iz*/ common_lang_constants::LOWER_I,
                    common_lang_constants::UPPER_I,
                ...
                stem<string_typeT>::find_r2(text, L"aeiouyAEIOUY");
                       ...
                       stem<string_typeT>::is_suffix(
                           text,
                           /*mm*/ common_lang_constants::LOWER_M,
                           common_lang_constants::UPPER_M,
                           common_lang_constants::LOWER_M,
                           common_lang_constants::UPPER_M) ||
                       stem<string_typeT>::is_suffix(
    ...
    void step_1c(string_typeT& text) {
        ...
        if (text.length() > 2 && !is_vowel(text[text.length() - 2])) {
            ...
            } else if (stem<string_typeT>::is_either(
                           text[text.length() - 1],
    ...
    void step_2(string_typeT& text) {
        ...
        } else if (text.length() >= 6 && stem<string_typeT>::is_suffix(
                                             text,
                                             /*biliti*/
                                             common_lang_constants::LOWER_B,
                                             common_lang_constants::UPPER_B,
        ...
        } else if (text.length() >= 4 && stem<string_typeT>::is_suffix(
                                             text,
                                             /*alli*/
                                             common_lang_constants::LOWER_A,
                                             common_lang_constants::UPPER_A,
            ...
            if (stem<string_typeT>::is_either(text[text.length() - 4],
                ...
                stem<string_typeT>::update_r_sections(text);
                   ...
                   stem<string_typeT>::is_suffix(
                       ...
                       common_lang_constants::LOWER_I,
                       common_lang_constants::UPPER_I)) {
            if (stem<string_typeT>::is_one_of(text[text.length() - 3],
    ...
    void step_3(string_typeT& text) {
        ...
        } else if (text.length() >= 5 && stem<string_typeT>::is_suffix(
                                             text,
                                             /*ative*/
                                             common_lang_constants::LOWER_A,
                                             common_lang_constants::UPPER_A,
        ...
        } else if (text.length() >= 3 && stem<string_typeT>::is_suffix(
                                             text,
                                             /*ful*/
                                             common_lang_constants::LOWER_F,
                                             common_lang_constants::UPPER_F,
        ...
        if (length == 2) {
            ...
            if (start > 0 && start == (length - 2) &&
                ...
                (!is_vowel(text[start + 1]) &&
                 ...
                 stem<string_typeT>::is_neither(text[start + 1], LOWER_Y_HASH,
                                                UPPER_Y_HASH)) &&
                // proceeding letter
                !is_vowel(text[start - 1])) {
                return true;

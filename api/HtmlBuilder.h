...
class HtmlBuilder {
   public:
    ...
    HtmlBuilder &begin();
    HtmlBuilder &append(const std::string &html);
...
#ifdef HTML_BUILDER_IMPLEMENTATION
#include <stdexcept>

HtmlBuilder::HtmlBuilder() { m_html = ""; }
...
HtmlBuilder &HtmlBuilder::begin() {
    m_html = "<!DOCTYPE html>";
    return *this;
}

HtmlBuilder &HtmlBuilder::append(const std::string &text) {
    m_html += text;
    return *this;
}

HtmlBuilder &HtmlBuilder::append(HtmlBuilder &builder) {
    m_html += builder.toString();
    return *this;
}
